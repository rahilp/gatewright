...
//
// `config.vocab.gate` is a list of strings, and a list of strings cannot
// explain itself: a new user meets `G0`, `P1` and `defect` on the board with
...
export const GLOSSARY_FIELDS = ['phase', 'priority', 'gate', 'type'];

function isPlainObject(value) {
  return typeof value === 'object' && value !== null && !Array.isArray(value);
}

// Returns the description map for one field: `{ G0: 'No gate: ...' }`, or an
