...
export const SETTINGS = [
  ...
  { key: 'policy.triage_required_for', type: 'list', summary: 'Actor kinds whose created items are held for triage.' },
...
export function coerceList(setting, raw) {
  ...
  if (!Array.isArray(parsed) || !parsed.length || !parsed.every((entry) => typeof entry === 'string' && entry.trim())) {
