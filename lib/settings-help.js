...
export const SETTING_HELP = {
  ...
  'policy.triage_required_for': {
    ...
    values: { entry: 'Each entry is a kind of author, such as agent, human or github. "agent" means work an AI agent adds waits until someone approves it; "github" means an item pulled from a GitHub issue waits, so nobody outside your team can put work in front of a running agent unreviewed.' },
  },
  'guard.enabled': {
